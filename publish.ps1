<#
.SYNOPSIS
    Publica Baby Radio, crea el paquete Velopack y lo sube a GitHub Releases.
...
.DESCPRIPCIÓN
    Requisitos:
      ...
      - GitHub token con permisos contents:write (variable GH_TOKEN o parámetro -Token)
...
$RepoName  = "Baby-Radio_TopRemix"
$AppId     = "BabyRadio"
$RID        = "win-x64"
$ProjectDir = $PSScriptRoot
$Csproj     = Join-Path $ProjectDir "BebeRadio.csproj"
